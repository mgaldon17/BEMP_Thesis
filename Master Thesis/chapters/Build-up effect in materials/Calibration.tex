...
In this comparison, TE-13 and TE-14 show similar and relatively higher slopes, between $3.1 \cdot 10^{-3}$ and $5.6 \cdot 10^{-3}$ [year]$^{-1}$, implying a consistent increase in sensitivity over the measured period. On the other hand, Mg-01 has a lower slope of $9.6 \cdot 10^{-3}$ [year]$^{-1}$, indicating a less pronounced change in sensitivity compared to the tissue equivalent chambers.