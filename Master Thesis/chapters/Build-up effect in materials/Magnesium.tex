...
\begin{minipage}{0.8\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/Build-up effect/Mg cylinder only.jpg}
    \label{fig:IC}
\end{minipage}
...
\begin{minipage}{0.8\textwidth}
    ...
    \centering
    \includegraphics[width=\linewidth]{figures/Build-up effect/Mg cylinder only - detail.jpg}
\end{minipage}
...
\begin{minipage}[t]{0.8\textwidth}
    \centering
    \includegraphics[width=\linewidth, height=9cm]{figures/Build-up effect/cross section of Mg.png} 
