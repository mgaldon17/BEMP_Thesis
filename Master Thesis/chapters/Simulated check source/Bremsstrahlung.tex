...
This first execution is intended to provide an insight into the natural braking radiation caused by the interaction of the electrons with the air. According to Section \ref{chapter:sampling of the emission spectra}, the emission spectrum is to be normalized to the activity of the samples. Additionally, the flux is normalized to the first particle to ease the understanding of the plot. 
...
\begin{figure}[!h]
    \begin{subfigure}{7 cm}
        ...
        \includegraphics[scale=0.4]{figures/Sr in VOID normalized to activity.jpg} 
    ...
    \begin{subfigure}{1 cm}
        ...
        \includegraphics[scale=0.4]{figures/Y in VOID normalized to activity.jpg}
...
In contrast, the yttrium decay leads to a \textbf{single gamma} photon emission at 1.76 \unit{\mega\electronvolt}, as specified in the source configuration. This photon is not shown on the graph because the probability is so low that the particle flux is barely noticeable when plotted along with the electron output.
...
\begin{figure}[!h]
    \begin{subfigure}{7 cm}
        %\captionsetup{margin={20pt,0pt}}
        \includegraphics[scale=0.42]{figures/Sr in air.jpg} 
        %\caption{Particle flux of \ce{^{90}Sr} in vacuum}
        \label{fig:Sr-90_air}
    \end{subfigure}
    \hspace{1cm}
    \begin{subfigure}{1 cm}
        \captionsetup{margin={0pt,-200pt}}
        \includegraphics[scale=0.4]{figures/Y in air.jpg}
        %\caption{Particle flux of \ce{^{90}Y} in vacuum}
        \label{fig:Y-90_air}
    \end{subfigure}
...
\begin{figure}[!h]
    \begin{subfigure}{6 cm}
        %\captionsetup{margin={20pt,0pt}}
        \includegraphics[scale=0.6]{figures/Sr BS spectrum.png} 
        %\caption{Particle flux of \ce{^{90}Sr} in vacuum}
    ...
    \begin{subfigure}{1 cm}
        \captionsetup{margin={0pt,-200pt}}
        \includegraphics[scale=0.605]{figures/Y BS spectrum.png}
        %\caption{Particle flux of \ce{^{90}Y} in vacuum}
...
Finally, the check source is configured in MCNP according the probabilities calculated earlier in this chapter, the geometry and relative positions of the source and the chamber, and the braking radiation spectrum discussed in this last section. 