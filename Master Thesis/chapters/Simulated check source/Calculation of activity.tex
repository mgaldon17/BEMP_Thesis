...
\multicolumn{1}{|c|}{\cellcolor[HTML]{A9D9C6}\#} & {\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}$<E_{\beta^{-}}>$ \\ {[}\unit{\kilo\electronvolt}{]}\end{tabular}} & \begin{tabular}[c]{@{}l@{}}$I_{\beta^{-}(abs)}$ \\  {[}\%{]}\end{tabular} & \begin{tabular}[c]{@{}l@{}}Daughter level \\  {[}keV{]}\end{tabular} & J$\pi$ & \begin{tabular}[c]{@{}l@{}}$E_{\beta^{-},max}$\\  {[}keV{]}\end{tabular} & Transition type \\ \hline
