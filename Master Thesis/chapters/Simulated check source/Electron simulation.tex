In the last section of this chapter the result of the simulation of the Sr-90 source as described up to this point is presented. The purpose is to study the dose deposition in the PTW chamber TM33054 when it is irradiated by a $\beta^-$ source. In this simulation, the chamber has the same corrosion layer as the simulations presented in Chapter 3. 
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale = 0.32]{figures/check source/+f6.jpg}
    \caption{Simulation of PTW-33054 with a 0.37 \unit{\milli\meter} thick layer of hydromagnesite on all magnesium surfaces using the check source, without a corrosion layer, and TE chamber. The magnesium chamber has been simulated without a concentration of water. Tally +F6.}
...
%\begin{figure}[!h]
%    \centering
%    \includegraphics[scale = 0.32]{figures/check source/energy deposition.jpg}
