...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/Imaging/reconstruction of EXRADIN CT corrosion Mg.png}
...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/Imaging/PTW CT corrosion Mg_1.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale = 0.2]{figures/Imaging/PTW CT corrosion Mg_2.png}
...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/Imaging/recon-filt-reslice-left.png}
\end{minipage}
\hfill
\begin{minipage}{0.53\textwidth}
    \centering
    \includegraphics[width=1.1\linewidth]{figures/Imaging/Neutron scan.jpg}
\end{minipage}
...
The final result has been averaged over all peaks. This average result is equal to:
