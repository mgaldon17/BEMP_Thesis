...
\begin{minipage}{0.5\textwidth}
    ...
    \centering
    \includegraphics[width=\linewidth]{figures/IC_scale.jpg}
...
\begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/IC closeup_scale.jpg}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/corrosion/Hydromagnesite/Neutrons and Photons/+F6.jpg}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/corrosion/Hydromagnesite/Neutrons and Photons/Energy deposition.jpg}
...
\begin{figure}[!h]
  \centering
    \centerline{\includegraphics[width=1.22\textwidth]{figures/corrosion/Hydromagnesite/Neutrons and Photons/electrons vs protons.jpg}}
...
However, photons and heavy ions do not play a role in the dose and their contribution is of the order of $10^{-13}$ and $10^{-14}$ \unit{\gray}, respectively. For this reason, their plots are not shown here.
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/corrosion/Hydromagnesite/Neutrons/+F6.jpg}
...
\newpage
The total energy deposition is also calculated in this simulation and is plotted in Figure \ref{fig:PTW-33053 with hydromagnesite. Energy deposition. Neutrons}.
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/corrosion/Hydromagnesite/Neutrons/energy deposition.jpg}
...
\begin{figure}[!h]
  \centering
    \centerline{\includegraphics[width=0.8\textwidth]{figures/corrosion/Hydromagnesite/Neutrons/neutrons.jpg}}
...
\begin{figure}[!h]
  \centering
    \centerline{\includegraphics[width=1.22\textwidth]{figures/corrosion/Hydromagnesite/Neutrons/electrons vs protons.jpg}}
  \caption{Simulation of PTW TM33054 with a 0.37 \unit{\milli\meter} thick layer of hydromagnesite on all magnesium surfaces. Electron and proton contribution.}
