...
Additional context regarding the corrosion of the PTW TM33054 ionization chamber is provided in the following subsection. The information provided relies in the doctoral work of Martin Jönsson done at the KTH Royal Institute of Technology in Stockholm, Sweden.

\section{Corrosion of Ionization Chambers}
\input{chapters/Atmospheric corrosion/03_Corrosion of Mg}
\section{X-Ray and Neutron Imaging}
\input{chapters/Atmospheric corrosion/03_Imaging of IC}
\section{Simulated Oxidation Layers}
\input{chapters/Atmospheric corrosion/03_Simulated MgO layers}